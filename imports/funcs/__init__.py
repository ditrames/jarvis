...
wikk = ["search wikihow"]
commands = [webcommand, goto_website, saystuff, yahoo, youtube, dprinter, cancer_can, wikk]    
functions = [google, go_to_website, say_str, yahoo_run, youtube_run, dprint, cancer, wikihow]